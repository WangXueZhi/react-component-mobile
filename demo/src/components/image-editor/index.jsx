...
export default class App extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: {"title":"图片编辑","prop":["{ Boolean } pinch 是否允许缩放 @default false\n","{ Boolean } rotate 是否允许旋转 @default false\n","{ String } className 样式名 @default \"\"\n","{ Function } cancle 取消回调\n","{ Function } reset 取消回调\n","{ Function } complete 取消回调\n"],"name":"ImageEditor"},
            openCode: false
        }
    }
