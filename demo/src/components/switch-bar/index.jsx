...
export default class App extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: {"title":"开关","prop":["{ String } textOpen 开的文本\r","{ String } textClose 关的文本\r","{ Boolean } disabled 不可点击\r","{ String } width 宽 @default \"44px\"\r","{ String } height 高 @default \"30px\"\r","{ String } iconColor icon颜色\r","{ String } iconSize icon尺寸\r","{ String } eye 眼睛开关\r","{ Function } onChange 开关改变回调\r","{ Boolean } isOpen 是否打开\r"],"name":"SwitchBar"},
            openCode: false
        }
    }
